    ...
    <div className={`min-h-screen ${colors.background} flex flex-col justify-center items-center p-8 transition-all duration-500 relative overflow-hidden`}>
      ...
      <div className="relative w-full max-w-md z-10">
        ...
        >
          ...
          >
            {t.yourEmotionsAreValid}<br />{t.letsExploreTogether}
          </motion.p>
      ...
      <motion.p 
        ...
        className={`${colors.text} opacity-50 text-center absolute bottom-8 z-10 px-4 py-2 rounded-full backdrop-blur-sm`}
        style={{ 
