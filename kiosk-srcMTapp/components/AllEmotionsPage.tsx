...
export function AllEmotionsPage({ onSelectEmotion, onBack }: AllEmotionsPageProps) {
  ...
  // Get all emotions as flat array
  const allEmotions = [
  ...
  }, [allEmotions, pointerPos, influenceRadius, opacityMin, opacityMax, scaleMin, scaleMax, brightnessMin, brightnessMax]);
  ...
  }, [allEmotions, scaleMin, opacityMin, brightnessMin]);
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="text-center">
            <h1 className={colors.text}>{t.allEmotions}</h1>
        ...
        {/* Mobile: Single 10x10 Grid */}
        <motion.div 
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 0.2 }}
          className="md:hidden grid grid-cols-10 gap-1 p-2"
        >
          <AnimatePresence>
            {allEmotions.map((emotion, index) => {
              ...
              // Determine color based on which quadrant the emotion belongs to
              let gradient = "from-gray-400 to-gray-500";
              if (emotions["high-pleasant"].includes(emotion)) {
                gradient = "from-yellow-400 via-green-400 to-yellow-500";
              } else if (emotions["high-unpleasant"].includes(emotion)) {
                gradient = "from-red-400 via-orange-400 to-red-500";
              } else if (emotions["low-pleasant"].includes(emotion)) {
                gradient = "from-green-400 via-teal-400 to-blue-400";
              } else if (emotions["low-unpleasant"].includes(emotion)) {
              ...
              return (
                <motion.button
                  ...
                  className={`
                    ...
                    text-white text-[8px] leading-tight p-1 transition-all rounded-lg
                ...
                >
                  ...
                  <span className="relative block z-10 text-center break-words hyphens-auto" style={{ lineHeight: '1.1' }}>
        ...
        <div className="hidden md:block space-y-12">
          {categories.map((category, categoryIndex) => (
            ...
            >
              <h2 className={`${colors.text} mb-6 text-center md:text-left`}>{category.title}</h2>
